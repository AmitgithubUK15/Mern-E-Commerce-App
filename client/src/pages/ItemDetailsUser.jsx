            ...
            <div className='flex flex-col gap-4'>
               ...
               <span className=' text-green-500 font-semibold text-xl'>{ productdetails &&Math.floor( productdetails.discountPrice/productdetails.regualarPrice *100)}% Off</span>
                  ...
                  <div className='py-3 flex gap-1 item-start'>
                    <div className=' '>
                       <button className="px-4 py-2 rounded-full border border-slate-600 text-slate-600 focus:border-blue-500 focus:text-blue-500 focus:bg-gray-200">S</button>
                    </div>
                    <div className=' '>
                    <button className="px-[13px] py-2 rounded-full border border-slate-600 text-slate-600 focus:border-blue-500 focus:text-blue-500 focus:bg-gray-200">M</button>
                    </div>
                    <div className=''>
                    <button className="px-4 py-2 rounded-full border border-slate-600 text-slate-600 focus:border-blue-500 focus:text-blue-500 focus:bg-gray-200">L</button>
                    </div>
                    <div className=' '>
                    <button className="px-3 py-2 rounded-full border border-slate-600 text-slate-600   focus:border-blue-500 focus:text-blue-500 focus:bg-gray-200" >XL</button>
                    </div>
                  </div>
                </div>   
