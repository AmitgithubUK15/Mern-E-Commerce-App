...
export default function ExploreProduct() {
  ...
  useEffect(()=>{
    ...
    try {
      ...
      const req = await axios.get(`${import.meta.env.VITE_SERVER_URL}/listing/getExplore?${searchQuerys}`)
      const res = req.data;
 ...
 async function clearFitler(){
  const urlParams = new URLSearchParams();
   ...
   urlParams.set("clothescategory",sideFilterSearch.clothescategorys = "")
    ...
    const req = await axios.get(`${import.meta.env.VITE_SERVER_URL}/listing/getExplore`)
    const res = req.data;
    dispatch(getExploreproducts(res));
    setLoading(false);
