  ...
  <div className='flex gap-8'>
   ...
   <div className='flex gap-8'>
     <div className='flex flex-col gap-3'>
       <div className='flex gap-2 items-center'>
        <label> Size 30</label>
        <input type="number" placeholder='Quantity' name="x" className='border w-24 sm:w-full outline-none p-3 rounded-lg'/>
    </div>

       <div className='flex gap-2 items-center'>
        <label> Size 32</label>
        <input type="number" placeholder='Quantity' name="m" className='border w-24 sm:w-full outline-none p-3 rounded-lg'/>
    </div>
     </div>
     <div className='flex flex-col gap-3'>
       <div className='flex gap-2 items-center'>
        <label> Size 34</label>
        <input type="number" placeholder='Quantity' name="l" className='border w-24 sm:w-full outline-none p-3 rounded-lg'/>
    </div>
       <div className='flex gap-2 items-center'>
        <label> Size 36</label>
        <input type="number" placeholder='Quantity' name="xl" className='border w-24 sm:w-full outline-none p-3 rounded-lg'/>
    </div>
     </div>
   </div>
   </div>
